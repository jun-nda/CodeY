...
Shader "CodeY/Blur/GaussianBlur"
{
	Properties
	{
		_MainTex("Base (RGB)", 2D) = "white" {}
		_DownSampleValue("DownSampleValue", Range(0,5)) = 1
	}
	...
	#pragma fragment frag_Blur
		...
		Pass
		{
			...
			//指定此通道的顶点着色器为vert_BlurHorizontal
	#pragma vertex vert_Black_White
			//指定此通道的像素着色器为frag_Blur
	...
	//【6】顶点着色函数 || Vertex Shader Function
	v2f vert_Black_White(VertexInput v)
	{
		v2f o;
	...
	//【7】片段着色函数 || Fragment Shader Function
	fixed4 frag_Black_White(v2f i) : SV_Target
	{
